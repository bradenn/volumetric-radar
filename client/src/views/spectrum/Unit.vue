...
<template>
    <Header :name="props.unit.metadata.name">
        ...
        <div class="d-flex gap-1 align-items-center">
            ...
            <Divider></Divider>
            <Tag :value="`${(Math.round((props.unit.temperature * 9/5 + 32)*100)/100).toFixed(2)}&deg; F`"
                 name="Temperature" :border="temperatureMap(props.unit.temperature)"></Tag>
            <Divider></Divider>
            <Tag :value="`${Math.round(props.unit.rssi)} dB`"
                 name="RSSI"></Tag>
        </div>
    </Header>
    <Beam v-if=false :zone="bedroom" :data="props.unit.phase" :pitch="props.unit.pan" :roll="props.unit.tilt"></Beam>
